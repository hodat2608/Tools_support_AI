...
layout_locnhan = [[sg.Text('')],
            ...
            [sg.Text('Chọn Stt nhãn '), sg.Input(size=(4,5), font=('Helvetica',12), key='TMP')],
...
layout_xoanhanok = [
            ...
            [sg.Button('RUN CAM1 -2-', size=(12,1), font=('Helvetica',10),key= 'RUN_CAM1'),
             sg.Button('RUN CAM2 -1-', size=(12,1), font=('Helvetica',10),key= 'RUN_CAM2')],]    
