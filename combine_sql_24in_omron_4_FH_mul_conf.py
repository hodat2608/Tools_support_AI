            ...
            if row1_a == str(i):
                for item in range(len(model.names)):
                    if int(row1_b) == item:
                        ...
                        window[f'PLC_OK_' + str(i)].update(value=str(row[29]))
...
def make_window(theme):
    ...
    layout_main = [
        ...
        [
        sg.Text('CAM 1 (KHONG TAP)',justification='center' ,font= ('Helvetica',30),text_color='red',expand_x=True,key='text_cam_1'),
        sg.Text('CAM 2 (KHONG TAP)',justification='center' ,font= ('Helvetica',30),text_color='red', expand_x=True,key='text_cam_2'),
        ],
        ...
        [
        sg.Text('CAM 3 (KHONG TAP)',justification='center' ,font= ('Helvetica',30),text_color='red',expand_x=True,key='text_cam_3'),
        sg.Text('CAM 4 (KHONG TAP)',justification='center' ,font= ('Helvetica',30),text_color='red', expand_y=True,key='text_cam_4'),
        ],
    ...
    layout_option2 = [
        ...
        [sg.Text('  OK',size=(15,1),font=('Helvetica',15), text_color='yellow'),
        sg.Text(' '*230), 
        sg.Input('0',size=(8,1),font=('Helvetica',15),key= 'PLC_OK_2',text_color='navy',enable_events=True)],
        [sg.Text(' ')],
    ...
    layout_option3 = [
        ...
        [sg.Text('  OK',size=(15,1),font=('Helvetica',15), text_color='yellow'),
        sg.Text(' '*230), 
        sg.Input('0',size=(8,1),font=('Helvetica',15),key= 'PLC_OK_3',text_color='navy',enable_events=True)],        
        [sg.Text(' ')],
    ...
    layout_option4 = [
        ...
        [sg.Text('  OK',size=(15,1),font=('Helvetica',15), text_color='yellow'),
        sg.Text(' '*230), 
        sg.Input('0',size=(8,1),font=('Helvetica',15),key= 'PLC_OK_4',text_color='navy',enable_events=True)],        
        [sg.Text(' ')],
    ...
    #layout = [[sg.Column(layout, scrollable = True)]],
...
p312 = (312).to_bytes(2, byteorder='big') + b'\x00'
#read_312 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p312) # doc thanh ghi 312
fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p312,b'\x00\x01',1)
...
try:
    while True:
        ...
        p310 = (310).to_bytes(2, byteorder='big') + b'\x00'
        read_310 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p310) # doc thanh ghi 310
        p312 = (312).to_bytes(2, byteorder='big') + b'\x00'
        read_312 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p312) # doc thanh ghi 312
        print(read_310[-1] ,' ', read_312[-1])
        
        if read_310 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x00'  and read_312 ==b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x01' :
            ...
            conn.close()
            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p312,b'\x00\x00',1)



        if read_310 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x02'  and read_312 ==b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x01' :

            window['choose_model'].update(value = '2')
            ...
            conn.close()
            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p312,b'\x00\x00',1)
            window['text_cam_1'].update(value = 'CAM 1 (CO TAP)')
            window['text_cam_2'].update(value = 'CAM 2 (CO TAP)')
            window['text_cam_3'].update(value = 'CAM 3 (CO TAP)')
            window['text_cam_4'].update(value = 'CAM 4 (CO TAP)')
        ...
        if event == 'Change2' or event == 'Change_2':
            ...
            for i,item in enumerate(range(len(model2.names))):
                ...
                list_variable[i][10] = values['PLC_OK_2']
                ...
                for name_label in model2.names:
                    if len(model2.names) <= len(list_variable):
                        if name_label == list_variable[i][0]:
                            ...
                            window['PLC_OK_2'].update(value= list_variable[i][10])
        ...
        if event == 'Change3' or event == 'Change_3':
            ...
            for i,item in enumerate(range(len(model3.names))):
                ...
                list_variable[i][10] = values['PLC_OK_3']
                ...
                for name_label in model3.names:
                    if len(model3.names) <= len(list_variable):
                        if name_label == list_variable[i][0]:
                            ...
                            window['PLC_OK_3'].update(value= list_variable[i][10])
        ...
        if event == 'Change4' or event == 'Change_4':
            ...
            for i,item in enumerate(range(len(model4.names))):
                ...
                list_variable[i][10] = values['PLC_OK_4']
                ...
                for name_label in model4.names:
                    if len(model4.names) <= len(list_variable):
                        if name_label == list_variable[i][0]:
                            ...
                            window['PLC_OK_4'].update(value= list_variable[i][10])
